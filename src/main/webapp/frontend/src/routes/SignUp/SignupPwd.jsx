...
const SignupPwd = () => {
  const { userInfo, setSignupPwdInfo, nextPage, prevPage } = useContext(LabelContext);
            ...
            <Grid container spacing={2} alignItems="center">
              <Grid item xs={12} sx={{ position: 'relative' }}>
                <input
                    ...
                    required
                    style={{ width: '100%', padding: '10px', paddingRight: '40px', border: '1px solid #5ac7c7', borderRadius: '5px', backgroundColor: '#e8f8f8' }}
                />
                <IconButton
