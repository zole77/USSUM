...
//
//     try {
//       const response = await axios.post("http://localhost8080/signup", null, {
...
const SignupId = () => {
    ...
    const checkDuplicate = async () => {
        ...
        try {
            ...
            console.error("Error checking duplicate ID:", error.response ? error.response.data : error.message);
