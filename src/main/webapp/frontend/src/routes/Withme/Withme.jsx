...
function Withme() {
  ...
  const [selectedDistrict, setSelectedDistrict] = useState(""); // 구 관리
  ...
  const handleCitySelect = (event) => {
    ...
    setSelectedDistrict(""); //시변경될때 구 초기화
  ...
  const handleDistrictSelect = (event) =>{
    ...
    console.log("gugu: ", selectedDistrict);
  ...
  return (
    <div className="Withme">
      ...
      <section className="right-section">
        <div className="location-text">같이 갈 위치 : {selectedCity} {selectedDistrict}
